...
def create_file(my_dict):
    ...
    with open(filename,'r+') as file:
        ...
        # file.write(for k, v in my_dict:
        #         print(k, v)
        # )

    # my_dict = zip(my_questions,myscore)
...
def Questions(): # questions
    ...
    input("press enter to veiw your score")
    ...
    my_dict = dict(zip(my_questions,myscore))

    create_file(my_dict)
# the candidate registering his bio detail and password
